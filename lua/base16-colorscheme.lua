...
function M.setup(colors, config)
    ...
    hi.StatusLineNC = { guifg = M.colors.base04, guibg = M.colors.base02, gui = 'none', guisp = nil }
    ...
    if M.config.telescope then
        if hex_re:match_str(M.colors.base00) and hex_re:match_str(M.colors.base01) and hex_re:match_str(M.colors.base02) then
            ...
            hi.TelescopeBorder       = { guifg = nil,              guibg = M.colors.base00,  gui = nil,    guisp = nil }
            hi.TelescopePromptBorder = { guifg = nil,              guibg = M.colors.base00,  gui = nil,    guisp = nil }
            hi.TelescopePromptNormal = { guifg = M.colors.base05,  guibg = M.colors.base00,  gui = nil,    guisp = nil }
            hi.TelescopePromptPrefix = { guifg = M.colors.base08,  guibg = M.colors.base00,  gui = nil,    guisp = nil }
            hi.TelescopeNormal       = { guifg = nil,              guibg = M.colors.base00,  gui = nil,    guisp = nil }
            hi.TelescopePreviewTitle = { guifg = darkercursorline, guibg = M.colors.base00,  gui = nil,    guisp = nil }
            hi.TelescopePromptTitle  = { guifg = darkercursorline, guibg = M.colors.base00,  gui = nil,    guisp = nil }
            hi.TelescopeResultsTitle = { guifg = darkerbg,         guibg = M.colors.base00,  gui = nil,    guisp = nil }
